...
function enviar_email($nombre){
	...
	$emailPara = $d_correo;
	$name = $d_nombre;
	$subject ='Sistema de Evaluación de Personal';
...
//$mail->Host       = "mailserver.mpps.gob.ve"; // SMTP server
 ...
 //$mail->Port = 465;
	  	$mail->Username   = "ladyquintero21@gmail.com";//"informaticasacs@gmail.com";//"webmastersacs@mpps.gob.ve"; // Cuenta de Usuario SMTP

         $mail->Password   = "2602%johnkeiber";//"sacs_informatica";//"sacs123";        // Password de la Cuenta SMTP
      //******
         $mail->AddReplyTo('ladyquintero21@gmail.com', 'webmaster');
